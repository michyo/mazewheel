...
function bike.on_punch(self, puncher, time_from_last_punch,
	...
	if not self.driver then
		...
		if not minetest.setting_getbool("creative_mode") then
			puncher:get_inventory():add_item("main", "mazewheel:bike")
		end
	end
end
...
function bike.on_step(self, dtime)
	...
	if math.abs(self.v) > 14 then
		self.v = 14 * get_sign(self.v)
	end
...
minetest.register_entity("mazewheel:bike", bike)


minetest.register_craftitem("mazewheel:bike", {
	description = "bike",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		minetest.add_entity(pointed_thing.under, "mazewheel:bike")
		if not minetest.setting_getbool("creative_mode") then
			itemstack:take_item()
		end
		return itemstack
