...
function car.on_punch(self, puncher, time_from_last_punch,
  ...
  if not self.driver then
    ...
    if not minetest.setting_getbool("creative_mode") then
      puncher:get_inventory():add_item("main", "mazewheel:car")
    end
  end
end
...
minetest.register_entity("mazewheel:car", car)


minetest.register_craftitem("mazewheel:car", {
  description = "Car",
  ...
  on_place = function(itemstack, placer, pointed_thing)
    ...
    minetest.add_entity(pointed_thing.under, "mazewheel:car")
    if not minetest.setting_getbool("creative_mode") then
      itemstack:take_item()
    end
    return itemstack
